  ...
  return (
    ...
    <div className="m-2 mb-5 p-5 rounded bg-lighterblue">
        ...
        <form onSubmit={(e) => {
          ...
          <textarea className='w-full rounded p-1' rows='3' type='text' placeholder='Write something...' value={tempMessage} onChange={(e) => setTempMessage(e.target.value)}></textarea>
